...
//    }
//
//    // 6. dismissOnTapOutside behaviour for overlay content:
//
//    //    Buttons automatically dismiss via tap propagation to the background
//    //    layer — no extra code needed.
//
//    //    To prevent a specific button from dismissing, use .noModalDismiss():
//    Button("Preview") { updatePreview() }
//        .noModalDismiss()   // tap is absorbed; overlay stays open
//
//    //    Toggles and Sliders consume their own taps so they never propagate —
//    //    they do NOT dismiss on their own. To make one dismiss, use
//    //    @DismissingState or call dismiss explicitly via onChange:
//
//    //    a) @DismissingState property wrapper — cleanest for panels:
...
//    }
//
//    //    b) Explicit onChange with environment dismiss action:
//    struct ModePanel: View {
...
///
/// Background tap layer behaviour:
...
// MARK: - Disable Dismiss

public enum ModalDismissBehavior: Equatable {  case disabled;  case enabled }

extension View {
	public func modalDismissBehavior(_ behavior: ModalDismissBehavior) -> some View {
		behavior == .disabled
		? AnyView(self.simultaneousGesture(TapGesture()))
		: AnyView(self)
	}
}
...
// Button that does NOT dismiss the overlay when tapped
// (e.g. a "preview" button that updates content without closing)
//SomeField()
//	.modalOverlay(isVisible: $showMenu, dismissOnTapOutside: true) {
//		VStack {
//			Button("Preview", systemImage: "eye") {
//				updatePreview()
//			}
//			.simultaneousGesture(TapGesture()) // absorbs tap, overlay stays open
//			
//			Button("Confirm", systemImage: "checkmark") {
//				confirmAction()
//			}
//			// no modifier — tap propagates, overlay dismisses
//		}
//	}
//
//// Toggle that DOES dismiss the overlay when changed
//// (e.g. a mode switcher that applies immediately and closes)
//struct ModePanel: View {
//	@Environment(\.dismissModalOverlay) private var dismiss
//	@Binding var isLandscape: Bool
//	
